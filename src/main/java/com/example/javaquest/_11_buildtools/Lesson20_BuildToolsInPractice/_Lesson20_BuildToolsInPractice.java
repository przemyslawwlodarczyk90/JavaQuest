package com.example.javaquest._11_buildtools.Lesson20_BuildToolsInPractice;

public class _Lesson20_BuildToolsInPractice {

    public static void main(String[] args) {

        System.out.println("=== LEKCJA 20: BUILD TOOLE W PRAKTYCE ZAWODOWEJ ===");
